...
function generateSymbol(){
    ...
    return symbols.charAt(randNum);  //charAt is function which denotes which character present at that index   
}
...
generateButton.addEventListener('click', () => {
    ...
    console.log("Compulsory addidtion done");
    ...
    console.log("Remaining addidtion done");
